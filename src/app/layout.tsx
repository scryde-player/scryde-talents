  ...
  return (
    <html lang="ru">
      <body className={`antialiased`}>
        ...
        })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=104101060', 'ym');

        ym(104101060, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true});
            `,
            }}
          />
